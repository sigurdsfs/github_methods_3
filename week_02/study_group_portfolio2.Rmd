...
*Model4 (f0mn ~ gender + (1|scenario) + (1|subject)) showed most explained variance with 80% of the variance being accounted for by both fixed and random effects. The largest second-level effect is random-intercept for subject in model4 (516.2).* 
